      ...
      <div className="corpo">  
        <div className="container">
          <section className="secao">
            ...
            Nós somos [Nome 1] e [Nome 2], desenvolvedores web com experiência na criação de plataformas digitais. 
          ...
          <section className="secao">
            ...
            <p className="paragrafo">
            A [Nome da Plataforma] é um projeto dedicado a oferecer educação acessível sobre investimentos. Para continuar melhorando nossos cursos e recursos, 
